...
## Fonts (added in a follow-up to issue #25)
...
The actual `.woff2` files will be added in a follow-up issue alongside the corresponding `@font-face` declarations. Until then, font stacks fall back to system fonts.
